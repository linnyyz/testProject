						...
						columns : [
								...
								},
								{
									...
									formatter : function(value, row, index) {
							        	...
							        	if(row.params!=null){
							        		return '<a class="detail-icon" href="javascript:detailException('+index+')">'+value+'</a><a class="detail-icon" href="javascript:closeDetail('+index+')"></a>';
							        	}else{
							        		return value;
							        	}
									}
...
function closeDetail(index) {
	   $('#exampleTable').bootstrapTable('collapseRow', index); 

}
function detailFormatter(index, row) {
	  
	 return '<font >'+'参数：'+jp.escapeHTML(row.params)+'</font>';
