...
import com.yizhi.common.utils.IPUtils;
...
public class Server {
    ...
    public void copyTo() throws Exception {
        ...
        setNetworkInfo(hal.getNetworkIFs());
    }
     ...
     * @param networkIFs
     */
    private void setNetworkInfo(NetworkIF[] networkIFs) {
    	for (NetworkIF net : networkIFs) {
    		Network network=new Network();
    		network.setName(net.getName());
    		network.setIpv4(net.getIPv4addr());
    		network.setIpv6(net.getIPv6addr());
    ...
    private void setSysInfo() {
        ...
        sys.setComputerIp(IPUtils.INTERNET_IP);
