...
import com.yizhi.common.dao.TaskDao;
import com.yizhi.common.domain.ScheduleJob;
import com.yizhi.common.domain.TaskDO;
import com.yizhi.common.quartz.utils.QuartzManager;
import com.yizhi.common.service.JobService;
import com.yizhi.common.utils.ScheduleJobUtils;
...
public class JobServiceImpl implements JobService {
	...
	@Override
	public int runAJobNow(Long jobId) throws SchedulerException {
		TaskDO scheduleJob = get(jobId);
		if (scheduleJob == null) {
			return -1;
		}
